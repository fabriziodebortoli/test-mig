...
REM cd %DevPath%\Standard\Taskbuilder\script
REM ECHO.ng-clean.bat
REM call ng-clean.bat 

REM @ECHO ON

REM %DevPath%\Standard\TaskBuilder\Framework\TbUtility\TbJson\tbjson.exe /ts %DevPath%\Standard\ 

REM @cd %DevPath%\Standard\Taskbuilder\client\web-form\ 

REM call npm i --no-save >> %DevPath%\5_npm_install.log
