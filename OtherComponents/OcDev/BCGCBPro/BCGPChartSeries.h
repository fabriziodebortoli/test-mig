...
protected:
	...
	void SetAnimatedValue(double dblPercentage, CBCGPChartData::ComponentIndex ci)
	{
...
protected:
	...
	void RecalcAnimatedValues(double dblValue, BOOL bReset = FALSE);
...
protected:
	...
	virtual CBCGPChartData::ComponentIndex GetDefaultAnimationComponentIndex(BCGPChartAnimationStyle animationStyle) const
	{
		return animationStyle == BCGPChartAnimationStyle_Slide ? CBCGPChartData::CI_X : CBCGPChartData::CI_Y1;
	}
...
public:
	...
	virtual CBCGPChartData::ComponentIndex GetDefaultAnimationComponentIndex(BCGPChartAnimationStyle animationStyle) const
	{
		return animationStyle == BCGPChartAnimationStyle_Slide ? CBCGPChartData::CI_X : CBCGPChartData::CI_Y;
	}
