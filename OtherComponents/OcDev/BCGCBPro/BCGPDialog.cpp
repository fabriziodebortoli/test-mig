...
//*************************************************************************************
void CBCGPDialog::SetControlInfoTip(UINT nCtrlID, LPCTSTR lpszInfoTip, DWORD dwVertAlign, BOOL bRedrawInfoTip)
{
	m_Impl.SetControlInfoTip(nCtrlID, lpszInfoTip, dwVertAlign, bRedrawInfoTip);
}
//*************************************************************************************
void CBCGPDialog::SetControlInfoTip(CWnd* pWndCtrl, LPCTSTR lpszInfoTip, DWORD dwVertAlign, BOOL bRedrawInfoTip)
{
...
BOOL CBCGPDialog::OnEraseBkgnd(CDC* pDC) 
{
	...
	if (m_brBkgr.GetSafeHandle () == NULL && m_hBkgrBitmap == NULL && !IsVisualManagerStyle ())
	{
