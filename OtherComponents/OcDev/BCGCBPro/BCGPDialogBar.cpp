...
//*************************************************************************************
void CBCGPDialogBar::SetControlInfoTip(UINT nCtrlID, LPCTSTR lpszInfoTip, DWORD dwVertAlign, BOOL bRedrawInfoTip)
{
	m_Impl.SetControlInfoTip(nCtrlID, lpszInfoTip, dwVertAlign, bRedrawInfoTip);
}
//*************************************************************************************
void CBCGPDialogBar::SetControlInfoTip(CWnd* pWndCtrl, LPCTSTR lpszInfoTip, DWORD dwVertAlign, BOOL bRedrawInfoTip)
{
	m_Impl.SetControlInfoTip(pWndCtrl, lpszInfoTip, dwVertAlign, bRedrawInfoTip);
}
//*************************************************************************************
...
void CBCGPDialogBar::OnMouseMove(UINT nFlags, CPoint point) 
{
	...
	if (m_Impl.m_pToolTipInfo->GetSafeHwnd () != NULL && !m_Impl.m_mapCtrlInfoTip.IsEmpty())
	{
		...
		HWND hwnd = m_Impl.GetControlInfoTipFromPoint(point, strTipText, strDescription);
