...
public:
	...
	void EnablePopupDialog(CRuntimeClass* pRTI, UINT nIDTemplate, BOOL bIsResizable = FALSE, BOOL bComboBoxMode = FALSE);
	void EnablePopupDialog(CRuntimeClass* pRTI, LPCTSTR lpszTemplateName, BOOL bIsResizable = FALSE, BOOL bComboBoxMode = FALSE);
