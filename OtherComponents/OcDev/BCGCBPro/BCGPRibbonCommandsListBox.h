...
// Operations
public:
	void FillFromCategory (CBCGPRibbonCategory* pCategory, BOOL bExludeDefaultPanelButtons = FALSE);
	...
	void FillFromArray (
		...
		BOOL bDeep, BOOL bIgnoreSeparators, BOOL bExludeDefaultPanelButtons = FALSE);
	void FillAll ();
