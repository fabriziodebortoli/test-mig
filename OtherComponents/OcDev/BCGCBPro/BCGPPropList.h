...
// Construction
public:
	CBCGPFileProp(const CString& strName, const CString& strFolderName, DWORD_PTR dwData = 0, LPCTSTR lpszDescr = NULL, UINT ulFlags = BIF_RETURNONLYFSDIRS);

	CBCGPFileProp(const CString& strName, UINT nID, const CString& strFolderName, DWORD_PTR dwData = 0, LPCTSTR lpszDescr = NULL, UINT ulFlags = BIF_RETURNONLYFSDIRS);
