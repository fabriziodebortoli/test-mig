...
void CBCGPMenuButton::OnShowMenu () 
{
	...
	int x = m_bRightArrow ? rectWindow.right : rectWindow.left;
	...
	if (m_pRTIPopupDlg != NULL)
	{
		...
		else
		{
			...
			if (pPopupMenu != NULL)
			{
				...
				{
					x = m_bRightArrow ? rectWindow.left : rectWindow.right;
				}
...
//********************************************************************************
void CBCGPMenuButton::EnablePopupDialog(CRuntimeClass* pRTI, UINT nIDTemplate, BOOL bIsResizable)
{
	EnablePopupDialog(pRTI, MAKEINTRESOURCE(nIDTemplate), bIsResizable);
}
//********************************************************************************
void CBCGPMenuButton::EnablePopupDialog(CRuntimeClass* pRTI, LPCTSTR lpszTemplateName, BOOL bIsResizable)
{
	ASSERT(pRTI != NULL);
