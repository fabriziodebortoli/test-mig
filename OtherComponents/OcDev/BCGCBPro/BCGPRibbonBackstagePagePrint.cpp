...
void CBCGPRibbonBackstagePagePrint::OnInitPrintControls()
{
	...
	m_btnPrev.SetStdImage (CBCGPMenuImages::IdArowLeftTab3d, CBCGPMenuImages::ImageBlack, (CBCGPMenuImages::IMAGES_IDS)-1, CBCGPMenuImages::ImageLtGray);

	m_btnNext.SetWindowText (_T(""));
	m_btnNext.SetStdImage (CBCGPMenuImages::IdArowRightTab3d, CBCGPMenuImages::ImageBlack, (CBCGPMenuImages::IMAGES_IDS)-1, CBCGPMenuImages::ImageLtGray);
