...
public:
	...
	void Enable3StateCheckBox(BOOL bEnable);
...
public:
	CBCGPGridPopupDlgItem(CString str, CRuntimeClass* pRTI, UINT nIDTemplate, BOOL bIsResizable = FALSE);
	...
	// Operations methods
public:
	void EnablePopupDialog(CRuntimeClass* pRTI, UINT nIDTemplate, BOOL bIsResizable = FALSE);
...
public:
	...
	void SetVisualManagerColorTheme(BOOL bSet = TRUE, BOOL bRedraw = TRUE, BOOL bAutoUpdateOnVMChange = TRUE);
