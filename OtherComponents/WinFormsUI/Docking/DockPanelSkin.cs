...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    public class DockPanelSkin
    {
		...
		private IDockPaneStripSkin m_dockPaneStripSkin;
        ...
        /// </summary>
        public IDockPaneStripSkin DockPaneStripSkin
        {
    ...
    public class DockPaneStripSkin : WeifenLuo.WinFormsUI.Docking.IDockPaneStripSkin 
    {
        protected DockPaneStripGradient m_DocumentGradient;
		protected DockPaneStripToolWindowGradient m_ToolWindowGradient;
		...
		public virtual void OverrideTheme ()
		{

		}

		private void SetDocumentTheme()
		{
    ...
    public class DockPanelGradient
    {
		...
		private bool m_bShowBorder = false;
		...
		/// The ending gradient color.
		/// </summary>
		[DefaultValue(typeof(bool), "Control")]
