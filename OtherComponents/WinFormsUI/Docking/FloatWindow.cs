...
namespace WeifenLuo.WinFormsUI.Docking
{
	public class FloatWindow : Form, INestedPanesContainer, IDockDragSource
	{
		...
		private void InternalConstruct(DockPanel dockPanel, DockPane pane, bool boundsSpecified, Rectangle bounds)
		{
			...
			//commentato: interferiva col processo di determinazione della parent delle finestre modali
			//nella afxmessagebox (funziona GetLastActivePopup): se ho un radar aperto da un report floating, il parent della messagebox
			//veniva impostato uguale alla finestra di documento e non al radar
