...
namespace Microarea.Library.SystemServices.ShellLink
{
	/// <remarks>
...
//		ShellLink m_LinkObj = new ShellLink();
//		if (m_Link == null)
//			throw new Exception("cannot initialize m_Link");
//		m_Link = m_LinkObj as IShellLinkW; // unicode support
//		if (m_Link == null)
//			m_Link = m_LinkObj as IShellLinkA; // no unicode support
//		if (m_Link == null)
//            throw new InvalidCastException("cannot cast m_Link");

		try
		{
			m_Link = (IShellLinkW) new ShellLink(); // unicode support
		}
		catch (InvalidCastException)
		{
			...
			{
				throw new Exception("unable to initialize m_Link");
			}
		}
...
//   #endif
    ...
    public string Arguments
    {
      get
      {
		...
		if (m_Link is IShellLinkW)
			((IShellLinkW)m_Link).GetArguments(sb, sb.Capacity);
		else
			((IShellLinkA)m_Link).GetArguments(sb, sb.Capacity);
      ...
      //set { m_Link.SetArguments( value ); }
		...
		{
			if (m_Link is IShellLinkW)
				((IShellLinkW)m_Link).SetArguments( value );
			else
				((IShellLinkA)m_Link).SetArguments( value );
		}
    }
    ...
    public string Description
    {
      get
      {
        StringBuilder sb = new StringBuilder( INFOTIPSIZE );
		  if (m_Link is IShellLinkW)
			  ((IShellLinkW)m_Link).GetDescription( sb, sb.Capacity );
		  else
			  ((IShellLinkA)m_Link).GetDescription( sb, sb.Capacity );
		  return sb.ToString();
      }
      //set { m_Link.SetDescription( value ); }
		...
		{
			if (m_Link is IShellLinkW)
				((IShellLinkW)m_Link).SetDescription( value );
			else
				((IShellLinkA)m_Link).SetDescription( value );
		}
	}
    ...
    public string WorkingDirectory
    {
      get
      {
        StringBuilder sb = new StringBuilder( MAX_PATH );
		  if (m_Link is IShellLinkW)
			  ((IShellLinkW)m_Link).GetWorkingDirectory( sb, sb.Capacity );
		  else
			  ((IShellLinkA)m_Link).GetWorkingDirectory( sb, sb.Capacity );
		  return sb.ToString();
      }
      //set { m_Link.SetWorkingDirectory( value ); }
		...
		{
			if (m_Link is IShellLinkW)
				((IShellLinkW)m_Link).SetWorkingDirectory( value );
			else
				((IShellLinkA)m_Link).SetWorkingDirectory( value );
		}
	}
...
//      #endif
		...
		if (m_Link is IShellLinkW)
		{
			WIN32_FIND_DATAW wfd = new WIN32_FIND_DATAW();	// unicode support
			((IShellLinkW)m_Link).GetPath( sb, sb.Capacity, out wfd, SLGP_FLAGS.SLGP_UNCPRIORITY );
		}
		else
		{
			WIN32_FIND_DATAA wfd = new WIN32_FIND_DATAA(); // no unicode support
			((IShellLinkA)m_Link).GetPath( sb, sb.Capacity, out wfd, SLGP_FLAGS.SLGP_UNCPRIORITY );
		}
      ...
      //set { m_Link.SetPath( value ); }
		...
		{
			if (m_Link is IShellLinkW)
				((IShellLinkW)m_Link).SetPath(value);
			else
				((IShellLinkA)m_Link).SetPath(value);
		}
	}
    ...
    public string IconPath
    {
      get
      {
        ...
        int nIconIdx;
		  if (m_Link is IShellLinkW)
			  ((IShellLinkW)m_Link).GetIconLocation( sb, sb.Capacity, out nIconIdx );
		  else
			  ((IShellLinkA)m_Link).GetIconLocation( sb, sb.Capacity, out nIconIdx );
		  return sb.ToString();
      }
      //set { m_Link.SetIconLocation( value, IconIndex ); }
		...
		{
			if (m_Link is IShellLinkW)
				((IShellLinkW)m_Link).SetIconLocation( value, IconIndex );
			else
				((IShellLinkA)m_Link).SetIconLocation( value, IconIndex );
		}
	}
    ...
    public int IconIndex
    {
      ...
      //set { m_Link.SetIconLocation( IconPath, value ); }
		...
		{
			if (m_Link is IShellLinkW)
				((IShellLinkW)m_Link).SetIconLocation( IconPath, value );
			else
				((IShellLinkA)m_Link).SetIconLocation( IconPath, value );
		}
	}
