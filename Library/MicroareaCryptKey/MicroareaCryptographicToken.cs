...
namespace Microarea.TaskBuilderNet.Licence.Activation
{
	...
	// ========================================================================
	public class MicroareaCryptographicToken : BinarySecurityToken/*MicroareaAsymmetricKey*/
	{
		private	Components.GenericMicroareaComponents	gen;
		public  static readonly string NamespaceURI =
					"http://www.Microarea.it/MicroareaCommunicationToken/";
		public  static readonly XmlQualifiedName TokenValueType =
					new XmlQualifiedName("MicroareaCryptographicToken", NamespaceURI);
		...
		// --------------------------------------------------------------------
		public MicroareaCryptographicToken() : base(TokenValueType)
		{
			gen = new Microarea.TaskBuilderNet.Licence.Activation.Components.GenericMicroareaComponents();
		...
		// --------------------------------------------------------------------
		public MicroareaCryptographicToken(XmlElement element) : base(element)
		{}
		...
		public override EncryptionKey EncryptionKey
		{
			get
			{
				...
				name.Value = "MicroareaCryptographicKey";
	...
	[SecurityPermission(SecurityAction.Demand,
		 Flags= SecurityPermissionFlag.UnmanagedCode)]
	// ========================================================================
	public class MicroareaCryptographicTokenBinaryDecryptionProvider :
															DecryptionKeyProvider
	{
										...
										(string algorithmUri, KeyInfo keyInfo)
		{
            ...
            Components.GenericMicroareaComponents gen =
				new Microarea.TaskBuilderNet.Licence.Activation.Components.GenericMicroareaComponents();
