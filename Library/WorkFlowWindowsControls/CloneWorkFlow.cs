...
namespace Microarea.Library.WorkFlowWindowsControls
{
	...
	public class CloneWorkFlow : System.Windows.Forms.Form
	{
		...
		//---------------------------------------------------------------------
		public CloneWorkFlow(string connectionString)
		{
			InitializeComponent();
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(CloneWorkFlow));
		...
		private void OkBtn_Click(object sender, System.EventArgs e)
		{
			...
			if (!WorkFlow.IsValidWorkFlowName(NameTextBox.Text, currentConnectionString))
			{	
				diagnostic.Set(DiagnosticType.Error, string.Format(WorkFlowString.WorkFlowNameAlreadyUsedErrMsgFmt, NameTextBox.Text));
				DiagnosticViewer.ShowDiagnostic(diagnostic);
