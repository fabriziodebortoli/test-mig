...
namespace TaskBuilderNetCore.Interfaces
{
    public interface ICustomizationContext
	{
		...
		bool AskAndCreateDefaultModuleIfNeeded();
		...
		bool IsValidExtension(string filefullPath);
		bool IsValidName(string name);
		bool NotAlone(string caption, int maxLogins, int maxDocuments, Object owner = null);
		...
		IEasyBuilderApp AddNewStandardModuleWrapper(string application, string module);
