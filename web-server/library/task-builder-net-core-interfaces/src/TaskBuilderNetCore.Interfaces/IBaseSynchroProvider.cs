...
namespace TaskBuilderNetCore.Interfaces
{
    ...
    public abstract class IBaseSynchroProvider
    {
        ...
        public abstract bool SetProviderParameters(string url, string username, string password, bool skipCrtValidation, string parameters, string iafmodule, out string message);
        ...
        public abstract void SynchronizeOutbound();
        ...
        public abstract bool ValidateDocument(string nameSpace, string guidDoc, string SerializesErrors, int workerId, out string message);
