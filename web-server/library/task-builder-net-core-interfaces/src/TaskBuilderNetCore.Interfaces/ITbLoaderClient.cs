...
namespace TaskBuilderNetCore.Interfaces
{
    public interface ITbLoaderClient
    {
        ...
        bool GetDocumentParameters(string command, ref string xmlParameters);
        ...
        int GetProcessID();
        bool GetReportParameters(string command, ref string xmlParameters);
        string GetReportSchema(string reportNamespace, string forUser);
        bool GetXMLExportParameters(string command, ref string xmlParameters, ref string[] messages);
        string GetXMLHotLink(string documentNamespace, string nsUri, string fieldXPath, string loginName);
        bool GetXMLImportParameters(string command, ref string xmlParameters, ref string[] messages);
		...
		int PlayStep(int step, bool isStepByStep, ref string[] messages);
		void Record();
		bool SetTestPlan(string xmlTestPlan);
		void SetTPManagerHandle(IntPtr handle, ref int tbProcessID, ref bool isTb2005);
