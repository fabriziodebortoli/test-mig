	...
	public class ProxySettings : State, ICloneable
	{
        ...
        */
		...
		public override bool Equals(object obj)
		{
			...
			return String.Compare(this.FirewallCredentialsSettings.Domain, ps.FirewallCredentialsSettings.Domain, StringComparison.OrdinalIgnoreCase) == 0 &&
				String.Compare(this.FirewallCredentialsSettings.Name, ps.FirewallCredentialsSettings.Name, StringComparison.OrdinalIgnoreCase) == 0 &&
				String.Compare(this.FirewallCredentialsSettings.Password, ps.FirewallCredentialsSettings.Password, StringComparison.OrdinalIgnoreCase) == 0 &&
				this.FirewallCredentialsSettings.NeedsCredentials == ps.FirewallCredentialsSettings.NeedsCredentials &&
				String.Compare(this.FtpProxy.Server, ps.FtpProxy.Server, StringComparison.OrdinalIgnoreCase) == 0 &&
				String.Compare(this.HttpProxy.Server, ps.HttpProxy.Server, StringComparison.OrdinalIgnoreCase) == 0 &&
