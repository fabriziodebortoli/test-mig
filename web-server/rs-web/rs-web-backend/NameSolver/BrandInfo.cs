...
public class BrandLoader : IBrandLoader
	...
	public class BrandInfo : IBrandInfo
    {
		...
		{
            return (String.Compare(ProductTitle, "Mago.Net", true, CultureInfo.InvariantCulture) == 0 ||
                 String.Compare(ProductTitle, "Mago4", true, CultureInfo.InvariantCulture) == 0 ||
                String.Compare(ProductTitle, "M4go", true, CultureInfo.InvariantCulture) == 0);
		}
