...
namespace Microarea.TaskBuilderNet.Interfaces
{
	...
	public sealed class RowSecurityObjectsXML
	{
		...
		public sealed class Element
		{
			...
			public const string DocumentNamespaces		= "DocumentNamespaces";
	...
	public sealed class NameSolverStrings
	{
        ...
        public const string M4Server                = "M4Server";
        public const string M4Client                = "M4Client";
        public const string Assets                  = "assets";

        public const string StandardDictionaryFile  = "Dictionary.bin";
        public const string M4ClientConfigFile      = "config.json";
