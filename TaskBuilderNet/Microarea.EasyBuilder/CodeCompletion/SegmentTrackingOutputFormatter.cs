...
namespace Microarea.EasyBuilder.CodeCompletion
{
	...
	/// </summary>
	//=============================================================================================
	internal class SegmentTrackingOutputFormatter : TextWriter
	{
		Dictionary<AstNode, ISegment> segments = new Dictionary<AstNode, ISegment>();
		Stack<int> startOffsets = new Stack<int>();
		readonly StringWriter stringWriter;

		public IDictionary<AstNode, ISegment> Segments { get { return segments; } }
		public override Encoding Encoding { get { return Encoding.Default; } }
		public SegmentTrackingOutputFormatter(StringWriter stringWriter) { this.stringWriter = stringWriter; }
		...
		public static IDictionary<AstNode, ISegment> WriteNode(StringWriter writer, AstNode node, CSharpFormattingOptions policy, ICSharpCode.AvalonEdit.TextEditorOptions options)
		{
			...
			var visitor = new CSharpOutputVisitor(formatter, AstFacilities.GetCSharpFormattingOptions());
