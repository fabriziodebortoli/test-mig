...
{
	partial class OverwriteFileWindow
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(OverwriteFileWindow));
			...
			// lblOverwrite
			// 
			resources.ApplyResources(this.lblOverwrite, "lblOverwrite");
			...
			this.btnNoToAll.DialogResult = System.Windows.Forms.DialogResult.Cancel;
			...
			this.CancelButton = this.btnNoToAll;
