...
namespace Microarea.EasyAttachment.Components
{
    ...
    /// </summary>
    public class MailDataObject : System.Windows.Forms.IDataObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MailDataObject"/> class.
        /// </summary>
        /// <param name="underlyingDataObject">The underlying data object to wrap.</param>
        public MailDataObject(System.Windows.Forms.IDataObject underlyingDataObject)
        {
