...
namespace Microarea.TaskBuilderNet.Core.MenuManagerLoader
{
	...
	public class MenuXmlParser : IMenuXmlParser
	{
		...
		//---------------------------------------------------------------------------
		public MenuXmlParser(ILoginManager aLoginManager)
		{
			...
			: this((aMenuXmlParser != null) ? aMenuXmlParser.LoginManager : null)
		{
			...
			if (aMenuXmlParser.menuXmlDoc != null)
				menuXmlDoc = (XmlDocument)aMenuXmlParser.menuXmlDoc.Clone();
		...
		//---------------------------------------------------------------------------
		[XmlIgnore]
		public ILoginManager LoginManager { get { return loginManager; }}
		...
		public MenuXmlNode CreateOfficeFileCommandNode(MenuXmlNode parentNode, string aModuleName, string officeFullFilename)
		{
			...
			if (String.Compare(officeExtension, NameSolverStrings.ExcelDocumentExtension, true, CultureInfo.InvariantCulture) == 0)
			{
			...
			else if (String.Compare(officeExtension, NameSolverStrings.ExcelTemplateExtension, true, CultureInfo.InvariantCulture) == 0)
			{
				officeApp = MenuXmlNode.OfficeItemApplication.Excel;
			...
			else if (String.Compare(officeExtension, NameSolverStrings.WordDocumentExtension, true, CultureInfo.InvariantCulture) == 0)
			{
				officeApp = MenuXmlNode.OfficeItemApplication.Word;
				officesubType = new MenuXmlNode.MenuXmlNodeCommandSubType(MenuXmlNode.MenuXmlNodeCommandSubType.XML_OFFICE_ITEM_SUBTYPE_DOCUMENT);
			}
			else if (String.Compare(officeExtension, NameSolverStrings.WordTemplateExtension, true, CultureInfo.InvariantCulture) == 0)
			{
				officeApp = MenuXmlNode.OfficeItemApplication.Word;
				officesubType = new MenuXmlNode.MenuXmlNodeCommandSubType(MenuXmlNode.MenuXmlNodeCommandSubType.XML_OFFICE_ITEM_SUBTYPE_TEMPLATE);
			}
			else if (String.Compare(officeExtension, NameSolverStrings.Excel2007DocumentExtension, true, CultureInfo.InvariantCulture) == 0)
			{
				officeApp = MenuXmlNode.OfficeItemApplication.Excel;
			...
			else if (String.Compare(officeExtension, NameSolverStrings.Excel2007TemplateExtension, true, CultureInfo.InvariantCulture) == 0)
			{
				officeApp = MenuXmlNode.OfficeItemApplication.Excel;
			...
			else if (String.Compare(officeExtension, NameSolverStrings.Word2007DocumentExtension, true, CultureInfo.InvariantCulture) == 0)
			{
				officeApp = MenuXmlNode.OfficeItemApplication.Word;
				officesubType = new MenuXmlNode.MenuXmlNodeCommandSubType(MenuXmlNode.MenuXmlNodeCommandSubType.XML_OFFICE_ITEM_SUBTYPE_DOCUMENT_2007);
			}
			else if (String.Compare(officeExtension, NameSolverStrings.Word2007TemplateExtension, true, CultureInfo.InvariantCulture) == 0)
			{
				officeApp = MenuXmlNode.OfficeItemApplication.Word;
				officesubType = new MenuXmlNode.MenuXmlNodeCommandSubType(MenuXmlNode.MenuXmlNodeCommandSubType.XML_OFFICE_ITEM_SUBTYPE_TEMPLATE_2007);
			}
			...
			) 
		{
            ...
            try
			{
				if (fileToLoad == null || fileToLoad.Length == 0 || commandsTypeToLoad == MenuLoader.CommandsTypeToLoad.Undefined)
					return false;
		...
		{
			return AddMenuNodeToExistingNode(parentNode, aMenuNodeToAdd, deep, MenuLoader.CommandsTypeToLoad.All);
		}
		...
		//---------------------------------------------------------------------------
		public MenuXmlNode AddMenuNode(MenuXmlNode aMenuNode, bool deep, MenuLoader.CommandsTypeToLoad commandsTypeToLoad)
		{
			try
			{
		...
		//---------------------------------------------------------------------------
		public MenuXmlNode AddCommandNode(MenuXmlNode aCommandNode, bool deep, MenuLoader.CommandsTypeToLoad commandsTypeToLoad)
		{
			try
			{
		...
		/// </summary>
		//---------------------------------------------------------------------------
		public bool LoadCommandShortcuts(MenuXmlNode aCommandShortcutsNode, MenuLoader.CommandsTypeToLoad commandsTypeToLoad)
		{
		...
		//---------------------------------------------------------------------------
		public MenuXmlNodeCollection GetAllCommands(string aCommandItemObject, MenuLoader.CommandsTypeToLoad commandsTypeToSearch)
		{
			if 
				(
				this.Root == null ||
				...
				commandsTypeToSearch == MenuLoader.CommandsTypeToLoad.Undefined
				)
				return null;
        ...
        public static bool IsImageFileSupported(FileInfo aFileInfo)
        {
            ...
            {
                if (String.Compare(aFileInfo.Extension, imageFileExtension, true, CultureInfo.InvariantCulture) == 0)
                    return true;
            }
            return false;
        }
		...
		//---------------------------------------------------------------------------
		private MenuXmlNode AddApplicationNode(MenuXmlNode aApplicationNodeToAdd, MenuLoader.CommandsTypeToLoad	commandsTypeToLoad)
		{
			MenuXmlNode applicationNode = null;
			try
			{
				if (aApplicationNodeToAdd == null || commandsTypeToLoad == MenuLoader.CommandsTypeToLoad.Undefined)
					return null;
			...
			if (fileInfos.Length > 0)
			{
				foreach (FileInfo aFileInfo in fileInfos)
				{
					if (IsImageFileSupported(aFileInfo))
					{
						...
						if (isFileNameComplete || String.Compare(imgFileName + aFileInfo.Extension, aFileInfo.Name, true, CultureInfo.InvariantCulture) == 0)
							return aFileInfo;
					}
				}
			}
	...
	//=================================================================================
	public class MenuXmlParserException : ApplicationException 
	{
