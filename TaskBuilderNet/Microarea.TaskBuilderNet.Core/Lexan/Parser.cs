...
namespace Microarea.TaskBuilderNet.Core.Lexan
{
	...
	internal class ParserState
	{
		...
		private Diagnostic	diagnostic = new Diagnostic("ParserState");
	...
	public class Parser : IDisposable
	{
		...
		public void SetError(Diagnostic diagnostic)
		{ 
			parserState.SetError(diagnostic); 
		}
		...
		//--------------------------------------------------------------------------------
		public bool SkipToToken(Token token, bool consumeToken, bool skipInnerBlock)
		{
			return SkipToToken (new Token[] { token }, consumeToken, skipInnerBlock);
		}

		//--------------------------------------------------------------------------------
		public bool SkipToToken(Token [] tokens, bool consumeToken, bool skipInnerBlock)
		{
			return SkipToToken(tokens, consumeToken, skipInnerBlock, false);
		}

		//--------------------------------------------------------------------------------
		public bool SkipToToken(Token [] tokens, bool consumeToken, bool skipInnerBlock, bool skipInnerRound)
		{
		...
		public bool ParseDateTime (out DateTime dt)
		{
			...
			if (strDate == "")
			{
				dt = ObjectHelper.NullTbDateTime;
				return true;
			}
