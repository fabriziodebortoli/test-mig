...
namespace Microarea.TaskBuilderNet.Core.CoreTypes
{
	...
	public class Parameter : IParameter
	{
		...
		{
			if (String.Compare(mode, "out", StringComparison.InvariantCultureIgnoreCase) == 0)
				return ParameterModeType.Out;

			if (String.Compare(mode, "in out", StringComparison.InvariantCultureIgnoreCase) == 0)
	...
	{
		protected IBaseModuleInfo moduleInfo = null;
...
//			Debug.Assert(i <= Parameters.Count);
		...
		public int ParamIndex(string name)
		{
			for (int i = 0; i < Parameters.Count; i++)
				if (string.Compare(name, Parameters[i].Name, true, CultureInfo.InvariantCulture) == 0) return i;
        ...
        public static FunctionPrototype ParseFunction(XmlElement functionElement)
        {
            ...
            if (report != null && string.Compare(bool.FalseString, report, true, CultureInfo.InvariantCulture) == 0)
                bReport = false;
    ...
    public class FunctionsList : IFunctions
    {
        ...
        public IDictionary<string, List<IFunctionPrototype>> ClassMethods =
            new Dictionary<string, List<IFunctionPrototype>>(StringComparer.InvariantCultureIgnoreCase);
        ...
        //-----------------------------------------------------------------------------
        private bool LoadPrototypes(IBaseModuleInfo mi)
        {
            string path = (mi == null)
                ? string.Empty
            ...
            // se non esiste la sezione allora la funzione è Undefined
        ...
        //    IBaseModuleInfo mi = BasePathFinder.BasePathFinderInstance.GetModuleInfo(ns);

        //    return LoadPrototypes(mi);
        //}

        //-----------------------------------------------------------------------------
        protected void LoadPrototypes(IBaseApplicationInfo ai)
        {
		...
		private void AddInternalWoormFunction()
		{
            ...
            Add(Token.TYPED_BARCODE, "String", new string[] { "String", "Int32", "Int32", "String", "Int32", "Int32" });
            Add(Token.TYPED_BARCODE, "String", new string[] { "String", "Int32", "Int32", "String", "Int32", "Int32", "String" });
            Add(Token.TYPED_BARCODE, "String", new string[] { "String", "Int32", "Int32", "String", "Int32", "Int32", "String", "Int32" });
        ...
        public FunctionPrototype GetPrototype(string name, int paramNo = -1)
        {
            ...
            //non dovrebbe mai passarci perchè vengona caricate sempre tutte
