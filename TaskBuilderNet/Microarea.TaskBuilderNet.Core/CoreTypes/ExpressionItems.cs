...
namespace Microarea.TaskBuilderNet.Core.CoreTypes
{
	...
	public class SymbolTable : IEnumerable, ISerializable
	{
		...
		protected Dictionary<string, string>      alias   = new Dictionary<string, string>(StringComparer.InvariantCultureIgnoreCase);
        protected Dictionary<string, Variable> symbols = new Dictionary<string, Variable>(StringComparer.InvariantCultureIgnoreCase);
