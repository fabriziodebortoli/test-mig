...
namespace Microarea.TaskBuilderNet.Core.Generic
{
	...
	public class InstallationVersion
	{
		...
		public void Save (string file)
		{
			...
			{
				throw new ApplicationException(string.Format(GenericStrings.ErrorSavingFile, file), ex);
			}
		}
		...
		public static InstallationVersion LoadFromOrCreate (string file)
		{
			...
			{
				throw new ApplicationException(string.Format(GenericStrings.ErrorLoadingFile, file), ex);
			}
		}
