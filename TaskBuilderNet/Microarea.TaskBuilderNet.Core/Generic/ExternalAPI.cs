...
namespace Microarea.TaskBuilderNet.Core.Generic
{
	public class ExternalAPI
	{
        ...
        public const int UM_MENU_MNG_RESIZING = ExternalAPI.WM_USER + 978;
        public const int UM_TILEPART_AFTER_RELAYOUT = ExternalAPI.WM_USER + 979;
        public const int UM_SEND_CURRENT_TOKEN = ExternalAPI.WM_USER + 980;
