...
private:
	...
	// partial actions
	BOOL			LoadSingleApplication		(const CString& sAppName, CParsersForModule&);
	AddOnModule*	LoadSingleModule			(const CString& strAddOnApp, const CString& strAddOnMod, CParsersForModule&, AddOnModsArray*, AddOnApplication*);
