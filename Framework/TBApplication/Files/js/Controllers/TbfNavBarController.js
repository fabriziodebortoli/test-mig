function TbfNavBarController($scope, $log, $location, $rootScope, $http, $route, $uibModal, imageService, menuService, settingsService, localizationService, generalFunctionsService, loggingService) {
    ...
    angular.element(document).ready(function () {
        ...
        $rootScope.$on('preferencesLoaded', function (event, object) {
            menuService.initMBF($scope.appMenu.Application);
            $scope.hideAll = false;
        });
    ...
    $scope.getApplications = function () {
        if ($scope.appMenu == undefined || $scope.appMenu == null)
            return;
        var apps = [];
        var tempAppArray = generalFunctionsService.ToArray($scope.menu.ApplicationMenu.AppMenu.Application);
