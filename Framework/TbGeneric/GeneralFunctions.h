...
TB_EXPORT int		FindEndBlock	(CString s, TCHAR chBegin, TCHAR chEnd, int startIndex = 0);
TB_EXPORT int		FindWord		(CString source, CString word, BOOL noCase = TRUE, int startIndex = 0, BOOL skipInnerRound = FALSE);
TB_EXPORT int		ReverseFindWord	(CString source, CString word, BOOL noCase = TRUE, int startIndex = -1, BOOL skipInnerRound = FALSE);
