...
//-----------------------------------------------------------------------------
//Il metodo � utilizzato pesantemente da Woorm/ReportStudio:
...
{
	//ottimizzazione: se l'immagine tramite path � la stessa non fa nulla
	...
	{
		//ottimizzazione: se l'immagine tramite namespace � la stessa non fa nulla
		BOOL bAddExt = FALSE;
