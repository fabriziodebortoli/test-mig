...
class TB_EXPORT BCMenu : public CMenu
{
...
public:
	...
	BOOL HasItems() {return m_MenuList.GetCount() > 0;}
	...
	void SetMenuDrawMode(UINT mode){
	...
	void SetSelectDisableMode(BOOL mode){
...
class TB_EXPORT BCMenuMemDC : public CDC
{
public:
...
///////////////////////////////////////////////////////////////////////////////
class TB_EXPORT CTBMenu: public BCMenu
{
public: 
	CTBMenu();
	BOOL AppendMenu(UINT nFlags, UINT_PTR nIDNewItem = NULL, LPCTSTR lpszNewItem = NULL, UINT nIDImg = 0);
};
