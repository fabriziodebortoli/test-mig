...
namespace Json {
   ...
   std::wstring JSON_API valueToString( Int value, Char* buffer);
   std::wstring JSON_API valueToString( UInt value, Char* buffer);
   std::wstring JSON_API valueToString( double value, Char* buffer);
   std::wstring JSON_API valueToString( bool value );
   std::wstring JSON_API valueToQuotedString( const char *value );
