...
//}
//
//inline Char *safeStringDup( const std::wstring &str )
//{
//   if ( !str.empty() )
//   {
...
public:
                                       ...
                                       unsigned int length = unknown )
   {
      ...
      Char *newString = static_cast<Char *>( malloc( (length + 1) * sizeof(Char) ) );
      memcpy( newString, value, length * sizeof(Char) );
      newString[length] = 0;
      return newString;
   }
...
Value::asString() const
{
   ...
   case arrayValue:
   case objectValue:
      JSON_ASSERT_MESSAGE( false, L"Type is not convertible to string" );
   default:
      JSON_ASSERT_UNREACHABLE;
   }
