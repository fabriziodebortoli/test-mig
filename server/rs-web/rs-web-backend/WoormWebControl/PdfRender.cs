...
//using PdfSharp.Drawing.Layout;            TODO rsweb
//using PdfSharp.Pdf;
...
namespace Microarea.RSWeb.WoormWebControl
{
 ...
 //                               fontStyleName,
	...
	//	{
	//		if (hide) return;
	//		XBrush brush = (new XSolidBrush(backColor));
 ...
 //                        WriteBarCodeXImage(xg, XImage.FromGdiPlusImage(img), cellRect);
	//				}
	//				File.Delete(bcv.GenericTmpFile);
 ...
 //           text = text.Replace("\\n", "\r\n");
	...
	//		XBrush brush = new XSolidBrush(woorm.TrueColor(BoxType.Text, color, fontStyleName));
 ...
 //       }
	...
	//	{	 
	//		XRect xRect = ScaleFromWoorm(rect);
	//		XBrush brush = (new XSolidBrush(Color.White));
