...
{  
    public class MessageBuilder
    {
        ...
        public enum CommandType { WRONG, NAMESPACE, INITTEMPLATE, TEMPLATE, ASK, UPDATEASK, ABORTASK, DATA, STOP, RUNREPORT, ENDREPORT, NONE, PREVASK, RERUN, EXPORTEXCEL, EXPORTDOCX, SNAPSHOT, RUNSNAPSHOT }
