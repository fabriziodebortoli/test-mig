...
//		//---------------------------------------------------------------------
//		public static CommandsTypeToLoad GetMenuCommandTypeToLoad(SecuredCommandType aSecuredCommandType)
//		{
//			switch (aSecuredCommandType)
//			{
//				case SecuredCommandType.Form:
//					return CommandsTypeToLoad.Form;

//				case SecuredCommandType.Batch:
//					return CommandsTypeToLoad.Batch;

//				case SecuredCommandType.Report:
//					return CommandsTypeToLoad.Report;

//				case SecuredCommandType.Function:
//					return CommandsTypeToLoad.Function;

//				case SecuredCommandType.ExcelDocument:
//				case SecuredCommandType.ExcelTemplate:
//                     return CommandsTypeToLoad.ExcelItem;

//				case SecuredCommandType.WordDocument:
//				case SecuredCommandType.WordTemplate:
//                     return CommandsTypeToLoad.WordItem;

//				default:
//					break;
//			}
			
//			return CommandsTypeToLoad.Undefined;
//		}
