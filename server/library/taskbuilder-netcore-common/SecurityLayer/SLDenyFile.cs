...
//			(
//			MenuXmlParser					aMenuXmlParser,
//			CommandsTypeToLoad	commandTypesToClean
//			)
//		{
//			try
//			{
...
//					(
//					aMenuXmlParser == null ||
//					commandTypesToClean == CommandsTypeToLoad.Undefined ||
//					fileInfo == null ||
//					fileInfo.FullName == null ||
//					fileInfo.FullName.Length == 0 ||
//					!Path.IsPathRooted(fileInfo.FullName) ||
...
//				if ((commandTypesToClean & CommandsTypeToLoad.Form) == CommandsTypeToLoad.Form)
//					CleanDeniedAccessesByType(aMenuXmlParser, denyXmlDocument, SecuredCommandType.Form);
//				if ((commandTypesToClean & CommandsTypeToLoad.Batch) == CommandsTypeToLoad.Batch)
//					CleanDeniedAccessesByType(aMenuXmlParser, denyXmlDocument, SecuredCommandType.Batch);
//				if ((commandTypesToClean & CommandsTypeToLoad.Report) == CommandsTypeToLoad.Report)
//					CleanDeniedAccessesByType(aMenuXmlParser, denyXmlDocument, SecuredCommandType.Report);
//				if ((commandTypesToClean & CommandsTypeToLoad.Function) == CommandsTypeToLoad.Function)
//					CleanDeniedAccessesByType(aMenuXmlParser, denyXmlDocument, SecuredCommandType.Function);
//				if ((commandTypesToClean & CommandsTypeToLoad.ExcelItem) == CommandsTypeToLoad.ExcelItem)
//				{
...
//				}
//				if ((commandTypesToClean & CommandsTypeToLoad.WordItem) == CommandsTypeToLoad.WordItem)
//				{
