...
namespace Microarea.Common.NameSolver
{
	...
	public class ModuleInfo
	{
		...
		/// Costruttore
		/// </summary>
		/// <param name="aParentApplicationInfo">l�applacazione a cui appartiene il modulo</param>
		//-------------------------------------------------------------------------------
		...
		{
			// Restituisco il titolo anzich� il nome del modulo in quanto tale stringa 
			// viene tradotta ed � quindi pi� significativa del nome
			return this.Title;
		}
		...
		public string GetProviderCreateScriptPath(string provider)
		{
			...
			// se � stato specificato un provider ritorna quello, altrimenti va nella All
