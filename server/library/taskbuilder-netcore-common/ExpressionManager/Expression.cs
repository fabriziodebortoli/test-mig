	...
	public class Expression
	{
		...
		Value ApplyFunction(FunctionItem function, Stack paramStack)
		{
			...
			switch (tkFun)
			{
				...
				//            case Token.TABLEEXISTS:         TODO rsweb
				//{
				//	DBConnection connection = null;
				//	try
				//	{	
				//	    connection = new DBConnection(ReportSession.CompanyDbConnection);
				//		connection.Open();
		...
		Value ApplyExternalFunction(FunctionItem function, Stack paramStack)
		{
			...
			catch (SoapClientException e)    //TODO rsweb
			{
