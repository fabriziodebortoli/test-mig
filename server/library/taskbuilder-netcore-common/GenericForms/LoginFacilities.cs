...
namespace Microarea.Common.GenericForms
{
	...
	public class LoginFacilities
	{
		...
		public static LoginManagerSession loginManagerSession = new LoginManagerSession();
		...
		public static void SetRememberMe(string checkedVal)
		{
			...
			if (loginManagerSession.LoginManagerState == LoginManagerState.Logged)
            ...
            string saveAutologinInfo, out string culture, out string uiCulture)//parametro non usato per gestire in un unico punto la riabilitazione dei controlli
		{
			...
			try
			{
				...
				loginManager.GetLoginInformation(loginManagerSession.AuthenticationToken);
