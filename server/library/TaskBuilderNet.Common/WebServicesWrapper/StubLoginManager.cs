...
namespace Microarea.Common.WebServicesWrapper
{
    ...
    public class LoginManager : ILoginManager
    {
        ...
        private MicroareaLoginManager loginManager = new MicroareaLoginManager();
        ...
        public string UserName
        {
            get
            {
                if (loginManagerState == LoginManagerState.UnInitialized)
                    throw new Exception(LoginManagerError.UnInitialized.ToString());
        ...
        public string CompanyName
        {
            get
            {
                if (loginManagerState != LoginManagerState.Logged)
                    throw new Exception(LoginManagerError.NotLogged.ToString());
        ...
        {
            return loginManager.GetUsagePercentageOnDBSize();
        }
...
*/
        ...
        {
            Dictionary<string, bool> list = new Dictionary<string, bool>(StringComparer.OrdinalIgnoreCase);
            ...
            while (expression != null && expression.Length > 0)
            {
                ...
                if (firstKeyIndex >= 0)
                {
                    if (firstKeyIndex == 0 && expression[0] != '!' && expression[0] != '(')
                    {
                        ...
                        throw new Exception(String.Format(WebServicesWrapperStrings.CheckActivationExpressionErrFmtMsg, expression));
                    }
        ...
        {
            throw new NotImplementedException();//loginManager.GetMessagesQueue(authenticationToken);
        }
        /// <summary>
        ...
        //----------------------------------------------------------------------
        public void SetClientData(/*ClientData cd TODO rsweb*/)
        {
            loginManager.SetClientData(/*cd TODO rsweb*/);
        }
        ...
        //---------------------------------------------------------------------------
        public bool CanUseNamespace(string nameSpace, LoginMngXml.GrantType grantType)
        {
        ...
        public bool CanUseNamespace(string nameSpace, TaskBuilderNetCore.Interfaces.GrantType grantType)
        {
            throw new NotImplementedException();
        }
