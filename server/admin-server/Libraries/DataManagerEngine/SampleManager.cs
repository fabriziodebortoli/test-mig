...
namespace Microarea.AdminServer.Libraries.DataManagerEngine
{
	...
	public class SampleManager
	{
		...
		{
            string standardDir = Path.Combine(contextInfo.PathFinder.GetStandardDataManagerSamplePath(appName, moduleName, SelectedIsoState),
				SelectedConfiguration);

            string customDir = Path.Combine(contextInfo.PathFinder.GetCustomDataManagerSamplePath(appName, moduleName, SelectedIsoState),
				SelectedConfiguration);
