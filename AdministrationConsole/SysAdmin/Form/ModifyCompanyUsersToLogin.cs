...
namespace Microarea.Console.Plugin.SysAdmin.Form
{
	...
	/// </summary>
	//=========================================================================
	public partial class ModifyCompanyUsersToLogin : PlugInsForm
	{
		...
		/// </summary>
		//---------------------------------------------------------------------
		public ModifyCompanyUsersToLogin(string	connectionString, SqlConnection	connection, string companyId)
		{
			InitializeComponent();	
		...
		/// </summary>
		//----------------------------------------------------------------------
		private void LoadDbUsers(string loginName)
		{
