...
/*Se un ruolo concede un grant, elimino una eventuale ereditariet proveniente da un altro ruolo*/
...
BEGIN
	...
	if @parout_thereis_parentgrant = 1
	BEGIN
		if @object_type = 15 /*Bodyedit*/
		BEGIN
...
BEGIN
	...
	BEGIN
		/*8: Delete Row, 16: Add/Insert Row, 32: Show RowView*/
		SET @parout_total_grant = (@parout_total_grant & (@parout_parent_grant | (8+ 16 + 32)))
	END
	ELSE
	BEGIN
