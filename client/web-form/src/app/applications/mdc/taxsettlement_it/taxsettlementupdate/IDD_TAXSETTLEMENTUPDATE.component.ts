...
export class IDD_TAXSETTLEMENTUPDATEComponent extends BOComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
		...
		boService.appendToModelStructure({'global':['FromSendingDate','ToSendingDate','TaxSettlementSendingDetail'],'TaxSettlementSendingDetail':['SendingDate','BalanceYear','Quarter','SendingStatus','TelProtocol','DocProtocol','l_TTaxSettlementSendingDetail_P02','l_TTaxSettlementSendingDetail_P03','l_TTaxSettlementSendingDetail_P04']});
