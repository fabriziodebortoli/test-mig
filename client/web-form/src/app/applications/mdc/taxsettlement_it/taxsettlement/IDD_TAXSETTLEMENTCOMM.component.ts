...
export class IDD_TAXSETTLEMENTCOMMComponent extends BOComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
		...
		boService.appendToModelStructure({'global':['Year','Quarter','ExceptionalEvents1','ExceptionalEvents2','ExceptionalEvents3','DifferentDeclarer','PositionCode_XML','DeclarerFiscalCode','CompanyDeclarerFiscalCode','TaxPayerCommitment','IntermediaryCommitment','CommitmentDate','IntermediaryFiscalCode','ConfirmingFlag','ProcessStatus']});
