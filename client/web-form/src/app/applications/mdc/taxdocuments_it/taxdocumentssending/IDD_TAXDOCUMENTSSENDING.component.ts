...
@Component({
    ...
    ngOnInit() {
        super.ngOnInit();
        		...
        		this.bo.appendToModelStructure({'global':['FromDate','ToDate','bAllSendingNo','bSelSendingNo','FromSendingNo','ToSendingNo','bAllSendingTypes','bSelSendingTypes','SendingType','EnhTaxDocSendings'],'EnhTaxDocSendings':['l_TEnhTaxDocSendings_P1','TaxDocSendingNo','SendingType','SetupDate','FromDate','ToDate']});
