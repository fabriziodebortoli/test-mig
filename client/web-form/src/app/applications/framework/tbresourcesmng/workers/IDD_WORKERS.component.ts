...
import { IDD_WORKERSService } from './IDD_WORKERS.service';

@Component({
    selector: 'tb-IDD_WORKERS',
    templateUrl: './IDD_WORKERS.component.html',
...
export class IDD_WORKERSFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_WORKERSComponent, resolver);
    }
} 