...
import { IDD_LOAD_RTSService } from './IDD_LOAD_RTS.service';

@Component({
    selector: 'tb-IDD_LOAD_RTS',
    templateUrl: './IDD_LOAD_RTS.component.html',
    providers: [IDD_LOAD_RTSService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_LOAD_RTSComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_LOAD_RTSService,
...
export class IDD_LOAD_RTSFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_LOAD_RTSComponent, resolver);
    }
} 