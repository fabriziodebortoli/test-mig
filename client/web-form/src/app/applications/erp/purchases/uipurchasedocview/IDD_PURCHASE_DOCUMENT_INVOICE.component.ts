...
import { IDD_PURCHASE_DOCUMENT_INVOICEService } from './IDD_PURCHASE_DOCUMENT_INVOICE.service';

@Component({
    selector: 'tb-IDD_PURCHASE_DOCUMENT_INVOICE',
    templateUrl: './IDD_PURCHASE_DOCUMENT_INVOICE.component.html',
...
public IDC_PURCH_DOC_SPEC_PHASE_2_ORDCOL_itemSource: any;
    ...
    constructor(document: IDD_PURCHASE_DOCUMENT_INVOICEService,
...
export class IDD_PURCHASE_DOCUMENT_INVOICEFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_PURCHASE_DOCUMENT_INVOICEComponent, resolver);
    }
} 