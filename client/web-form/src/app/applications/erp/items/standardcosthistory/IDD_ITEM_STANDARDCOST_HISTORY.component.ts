...
import { IDD_ITEM_STANDARDCOST_HISTORYService } from './IDD_ITEM_STANDARDCOST_HISTORY.service';

@Component({
    selector: 'tb-IDD_ITEM_STANDARDCOST_HISTORY',
    templateUrl: './IDD_ITEM_STANDARDCOST_HISTORY.component.html',
    providers: [IDD_ITEM_STANDARDCOST_HISTORYService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
    export class IDD_ITEM_STANDARDCOST_HISTORYComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_ITEM_STANDARDCOST_HISTORYService,
...
export class IDD_ITEM_STANDARDCOST_HISTORYFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_ITEM_STANDARDCOST_HISTORYComponent, resolver);
    }
} 