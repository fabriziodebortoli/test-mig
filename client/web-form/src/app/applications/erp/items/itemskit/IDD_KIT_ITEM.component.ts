...
import { IDD_KIT_ITEMService } from './IDD_KIT_ITEM.service';

@Component({
    selector: 'tb-IDD_KIT_ITEM',
    templateUrl: './IDD_KIT_ITEM.component.html',
...
export class IDD_KIT_ITEMFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_KIT_ITEMComponent, resolver);
    }
} 