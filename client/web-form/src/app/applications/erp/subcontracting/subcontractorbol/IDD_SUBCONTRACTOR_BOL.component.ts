...
import { IDD_SUBCONTRACTOR_BOLService } from './IDD_SUBCONTRACTOR_BOL.service';

@Component({
    selector: 'tb-IDD_SUBCONTRACTOR_BOL',
    templateUrl: './IDD_SUBCONTRACTOR_BOL.component.html',
    providers: [IDD_SUBCONTRACTOR_BOLService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
    export class IDD_SUBCONTRACTOR_BOLComponent extends BOComponent implements OnInit, OnDestroy {
...
public IDC_PURCH_DOC_SPEC_PHASE_2_ORDCOL_itemSource: any;
    ...
    constructor(document: IDD_SUBCONTRACTOR_BOLService,
...
export class IDD_SUBCONTRACTOR_BOLFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_SUBCONTRACTOR_BOLComponent, resolver);
    }
} 