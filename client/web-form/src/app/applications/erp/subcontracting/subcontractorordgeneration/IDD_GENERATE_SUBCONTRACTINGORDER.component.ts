...
import { IDD_GENERATE_SUBCONTRACTINGORDERService } from './IDD_GENERATE_SUBCONTRACTINGORDER.service';

@Component({
    selector: 'tb-IDD_GENERATE_SUBCONTRACTINGORDER',
    templateUrl: './IDD_GENERATE_SUBCONTRACTINGORDER.component.html',
    providers: [IDD_GENERATE_SUBCONTRACTINGORDERService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_GENERATE_SUBCONTRACTINGORDERComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_GENERATE_SUBCONTRACTINGORDERService,
...
export class IDD_GENERATE_SUBCONTRACTINGORDERFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_GENERATE_SUBCONTRACTINGORDERComponent, resolver);
    }
} 