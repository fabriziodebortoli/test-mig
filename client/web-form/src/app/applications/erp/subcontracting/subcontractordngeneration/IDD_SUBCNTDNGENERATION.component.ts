...
import { IDD_SUBCNTDNGENERATIONService } from './IDD_SUBCNTDNGENERATION.service';

@Component({
    selector: 'tb-IDD_SUBCNTDNGENERATION',
    templateUrl: './IDD_SUBCNTDNGENERATION.component.html',
    providers: [IDD_SUBCNTDNGENERATIONService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
    export class IDD_SUBCNTDNGENERATIONComponent extends BOComponent implements OnInit, OnDestroy {
     public IDC_DNGENERATION_LE_BE_CODETYPE_SPEC_itemSource: any;

    constructor(document: IDD_SUBCNTDNGENERATIONService,
...
export class IDD_SUBCNTDNGENERATIONFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_SUBCNTDNGENERATIONComponent, resolver);
    }
} 