...
import { IDD_PURCHREQGENService } from './IDD_PURCHREQGEN.service';

@Component({
    selector: 'tb-IDD_PURCHREQGEN',
    templateUrl: './IDD_PURCHREQGEN.component.html',
    providers: [IDD_PURCHREQGENService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_PURCHREQGENComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_PURCHREQGENService,
...
export class IDD_PURCHREQGENFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_PURCHREQGENComponent, resolver);
    }
} 