...
import { IDD_PURCHASEREQService } from './IDD_PURCHASEREQ.service';

@Component({
    selector: 'tb-IDD_PURCHASEREQ',
    templateUrl: './IDD_PURCHASEREQ.component.html',
...
export class IDD_PURCHASEREQFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_PURCHASEREQComponent, resolver);
    }
} 