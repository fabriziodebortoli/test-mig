...
import { IDD_ANNUALTAXDECLARATIONService } from './IDD_ANNUALTAXDECLARATION.service';

@Component({
    selector: 'tb-IDD_ANNUALTAXDECLARATION',
    templateUrl: './IDD_ANNUALTAXDECLARATION.component.html',
...
export class IDD_ANNUALTAXDECLARATIONFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_ANNUALTAXDECLARATIONComponent, resolver);
    }
} 