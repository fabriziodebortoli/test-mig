...
import { IDD_BILLSAPPROVALService } from './IDD_BILLSAPPROVAL.service';

@Component({
    selector: 'tb-IDD_BILLSAPPROVAL',
    templateUrl: './IDD_BILLSAPPROVAL.component.html',
    providers: [IDD_BILLSAPPROVALService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_BILLSAPPROVALComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_BILLSAPPROVALService,
...
export class IDD_BILLSAPPROVALFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_BILLSAPPROVALComponent, resolver);
    }
} 