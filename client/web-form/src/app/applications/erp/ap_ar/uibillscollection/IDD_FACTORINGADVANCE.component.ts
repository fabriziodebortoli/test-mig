...
import { IDD_FACTORINGADVANCEService } from './IDD_FACTORINGADVANCE.service';

@Component({
    selector: 'tb-IDD_FACTORINGADVANCE',
    templateUrl: './IDD_FACTORINGADVANCE.component.html',
    providers: [IDD_FACTORINGADVANCEService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_FACTORINGADVANCEComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_FACTORINGADVANCEService,
...
export class IDD_FACTORINGADVANCEFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_FACTORINGADVANCEComponent, resolver);
    }
} 