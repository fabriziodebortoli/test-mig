...
import { IDD_COAGROUPSService } from './IDD_COAGROUPS.service';

@Component({
    selector: 'tb-IDD_COAGROUPS',
    templateUrl: './IDD_COAGROUPS.component.html',
...
export class IDD_COAGROUPSFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_COAGROUPSComponent, resolver);
    }
} 