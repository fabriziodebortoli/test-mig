...
import { IDD_REASONService } from './IDD_REASON.service';

@Component({
    selector: 'tb-IDD_REASON',
    templateUrl: './IDD_REASON.component.html',
...
export class IDD_REASONFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_REASONComponent, resolver);
    }
} 