...
import { IDD_PRESHIPPINGService } from './IDD_PRESHIPPING.service';

@Component({
    selector: 'tb-IDD_PRESHIPPING',
    templateUrl: './IDD_PRESHIPPING.component.html',
    providers: [IDD_PRESHIPPINGService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_PRESHIPPINGComponent extends BOComponent implements OnInit, OnDestroy {
     public IDC_BOM_PRESHIPPING_COMP_UOM_itemSource: any;

    constructor(document: IDD_PRESHIPPINGService,
...
export class IDD_PRESHIPPINGFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_PRESHIPPINGComponent, resolver);
    }
} 