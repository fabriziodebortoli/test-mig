...
import { IDD_DN_FROM_PRESHIPPINGService } from './IDD_DN_FROM_PRESHIPPING.service';

@Component({
    selector: 'tb-IDD_DN_FROM_PRESHIPPING',
    templateUrl: './IDD_DN_FROM_PRESHIPPING.component.html',
    providers: [IDD_DN_FROM_PRESHIPPINGService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_DN_FROM_PRESHIPPINGComponent extends BOComponent implements OnInit, OnDestroy {
     public IDC_DN_FROM_PRESHIPPING_TYPE_itemSource: any;

    constructor(document: IDD_DN_FROM_PRESHIPPINGService,
...
export class IDD_DN_FROM_PRESHIPPINGFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_DN_FROM_PRESHIPPINGComponent, resolver);
    }
} 