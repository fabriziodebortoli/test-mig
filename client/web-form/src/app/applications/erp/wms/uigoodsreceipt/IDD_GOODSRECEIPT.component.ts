...
import { IDD_GOODSRECEIPTService } from './IDD_GOODSRECEIPT.service';

@Component({
    selector: 'tb-IDD_GOODSRECEIPT',
    templateUrl: './IDD_GOODSRECEIPT.component.html',
    providers: [IDD_GOODSRECEIPTService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_GOODSRECEIPTComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_GOODSRECEIPTService,
...
export class IDD_GOODSRECEIPTFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_GOODSRECEIPTComponent, resolver);
    }
} 