...
import { IDD_TO_FROM_PSHService } from './IDD_TO_FROM_PSH.service';

@Component({
    selector: 'tb-IDD_TO_FROM_PSH',
    templateUrl: './IDD_TO_FROM_PSH.component.html',
...
export class IDD_TO_FROM_PSHFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_TO_FROM_PSHComponent, resolver);
    }
} 