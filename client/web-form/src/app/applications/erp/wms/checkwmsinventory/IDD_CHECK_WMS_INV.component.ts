...
import { IDD_CHECK_WMS_INVService } from './IDD_CHECK_WMS_INV.service';

@Component({
    selector: 'tb-IDD_CHECK_WMS_INV',
    templateUrl: './IDD_CHECK_WMS_INV.component.html',
    providers: [IDD_CHECK_WMS_INVService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
    export class IDD_CHECK_WMS_INVComponent extends BOComponent implements OnInit, OnDestroy {
     public IDC_CHECKWMSINVENTORY_PROPOSED_UNIT_VALUE_itemSource: any;

    constructor(document: IDD_CHECK_WMS_INVService,
...
export class IDD_CHECK_WMS_INVFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_CHECK_WMS_INVComponent, resolver);
    }
} 