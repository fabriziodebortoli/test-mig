...
import { IDD_TOCONFIRMATIONService } from './IDD_TOCONFIRMATION.service';

@Component({
    selector: 'tb-IDD_TOCONFIRMATION',
    templateUrl: './IDD_TOCONFIRMATION.component.html',
    providers: [IDD_TOCONFIRMATIONService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
    export class IDD_TOCONFIRMATIONComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_TOCONFIRMATIONService,
...
export class IDD_TOCONFIRMATIONFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_TOCONFIRMATIONComponent, resolver);
    }
} 