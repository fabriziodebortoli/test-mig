...
import { IDD_STOCK_TRANSFERService } from './IDD_STOCK_TRANSFER.service';

@Component({
    selector: 'tb-IDD_STOCK_TRANSFER',
    templateUrl: './IDD_STOCK_TRANSFER.component.html',
...
public IDC_STOCK_TRANSFER_CONSPARTNER_BE_hotLink: any;
    ...
    constructor(document: IDD_STOCK_TRANSFERService,
...
export class IDD_STOCK_TRANSFERFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_STOCK_TRANSFERComponent, resolver);
    }
} 