...
import { IDD_SUPPLIERCLASSIFICATIONService } from './IDD_SUPPLIERCLASSIFICATION.service';

@Component({
    selector: 'tb-IDD_SUPPLIERCLASSIFICATION',
    templateUrl: './IDD_SUPPLIERCLASSIFICATION.component.html',
...
export class IDD_SUPPLIERCLASSIFICATIONFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_SUPPLIERCLASSIFICATIONComponent, resolver);
    }
} 