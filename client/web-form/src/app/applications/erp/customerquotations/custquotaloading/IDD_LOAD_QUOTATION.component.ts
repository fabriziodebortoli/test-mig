...
import { IDD_LOAD_QUOTATIONService } from './IDD_LOAD_QUOTATION.service';

@Component({
    selector: 'tb-IDD_LOAD_QUOTATION',
    templateUrl: './IDD_LOAD_QUOTATION.component.html',
    providers: [IDD_LOAD_QUOTATIONService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_LOAD_QUOTATIONComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_LOAD_QUOTATIONService,
...
export class IDD_LOAD_QUOTATIONFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_LOAD_QUOTATIONComponent, resolver);
    }
} 