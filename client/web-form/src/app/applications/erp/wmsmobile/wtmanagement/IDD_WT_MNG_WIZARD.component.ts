...
import { IDD_WT_MNG_WIZARDService } from './IDD_WT_MNG_WIZARD.service';

@Component({
    selector: 'tb-IDD_WT_MNG_WIZARD',
    templateUrl: './IDD_WT_MNG_WIZARD.component.html',
...
export class IDD_WT_MNG_WIZARDFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_WT_MNG_WIZARDComponent, resolver);
    }
} 