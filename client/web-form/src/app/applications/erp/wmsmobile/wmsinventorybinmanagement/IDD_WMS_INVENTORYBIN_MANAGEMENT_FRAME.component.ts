...
import { IDD_WMS_INVENTORYBIN_MANAGEMENT_FRAMEService } from './IDD_WMS_INVENTORYBIN_MANAGEMENT_FRAME.service';

@Component({
    selector: 'tb-IDD_WMS_INVENTORYBIN_MANAGEMENT_FRAME',
    templateUrl: './IDD_WMS_INVENTORYBIN_MANAGEMENT_FRAME.component.html',
    providers: [IDD_WMS_INVENTORYBIN_MANAGEMENT_FRAMEService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_WMS_INVENTORYBIN_MANAGEMENT_FRAMEComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_WMS_INVENTORYBIN_MANAGEMENT_FRAMEService,
...
export class IDD_WMS_INVENTORYBIN_MANAGEMENT_FRAMEFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_WMS_INVENTORYBIN_MANAGEMENT_FRAMEComponent, resolver);
    }
} 