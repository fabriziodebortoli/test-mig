...
import { IDD_MOCONFIRMATIONService } from './IDD_MOCONFIRMATION.service';

@Component({
    selector: 'tb-IDD_MOCONFIRMATION',
    templateUrl: './IDD_MOCONFIRMATION.component.html',
...
export class IDD_MOCONFIRMATIONFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_MOCONFIRMATIONComponent, resolver);
    }
} 