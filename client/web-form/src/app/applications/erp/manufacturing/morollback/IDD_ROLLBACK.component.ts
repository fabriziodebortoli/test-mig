...
import { IDD_ROLLBACKService } from './IDD_ROLLBACK.service';

@Component({
    selector: 'tb-IDD_ROLLBACK',
    templateUrl: './IDD_ROLLBACK.component.html',
...
public IDC_LABOUR_DETAILS_ESTIMATED_LABOUR_TYPE_itemSource: any;
    ...
    constructor(document: IDD_ROLLBACKService,
    ...
    ngOnInit() {
        super.ngOnInit();
        this.IDC_ROLLBACK_MOSTATUS_itemSource = {
  "name": "StatusEnumCombo",
  "namespace": "ERP.Manufacturing.Documents.MORollbackStatusItemSource"
}; 
this.IDC_ROLLBACK_BE_STATUS_itemSource = {
  "name": "StatusBEEnumCombo",
  "namespace": "ERP.Manufacturing.Documents.MORollbackStatusBEItemSource"
}; 
...
export class IDD_ROLLBACKFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_ROLLBACKComponent, resolver);
    }
} 