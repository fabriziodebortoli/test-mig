...
import { IDD_PRODPLAN_SELECTIONS_ORD_CUSTService } from './IDD_PRODPLAN_SELECTIONS_ORD_CUST.service';

@Component({
    selector: 'tb-IDD_PRODPLAN_SELECTIONS_ORD_CUST',
    templateUrl: './IDD_PRODPLAN_SELECTIONS_ORD_CUST.component.html',
...
export class IDD_PRODPLAN_SELECTIONS_ORD_CUSTFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_PRODPLAN_SELECTIONS_ORD_CUSTComponent, resolver);
    }
} 