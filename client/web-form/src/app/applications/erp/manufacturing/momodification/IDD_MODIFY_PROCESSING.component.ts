...
import { IDD_MODIFY_PROCESSINGService } from './IDD_MODIFY_PROCESSING.service';

@Component({
    selector: 'tb-IDD_MODIFY_PROCESSING',
    templateUrl: './IDD_MODIFY_PROCESSING.component.html',
...
export class IDD_MODIFY_PROCESSINGFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_MODIFY_PROCESSINGComponent, resolver);
    }
} 