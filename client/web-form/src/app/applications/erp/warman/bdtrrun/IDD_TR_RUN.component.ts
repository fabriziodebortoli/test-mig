...
import { IDD_TR_RUNService } from './IDD_TR_RUN.service';

@Component({
    selector: 'tb-IDD_TR_RUN',
    templateUrl: './IDD_TR_RUN.component.html',
    providers: [IDD_TR_RUNService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_TR_RUNComponent extends BOComponent implements OnInit, OnDestroy {
     public IDC_TR_RUN_SEL_DOCTYPE_itemSource: any;

    constructor(document: IDD_TR_RUNService,
...
export class IDD_TR_RUNFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_TR_RUNComponent, resolver);
    }
} 