...
import { IDD_SALE_ORDER_ALLOCATIONService } from './IDD_SALE_ORDER_ALLOCATION.service';

@Component({
    selector: 'tb-IDD_SALE_ORDER_ALLOCATION',
    templateUrl: './IDD_SALE_ORDER_ALLOCATION.component.html',
    providers: [IDD_SALE_ORDER_ALLOCATIONService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_SALE_ORDER_ALLOCATIONComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_SALE_ORDER_ALLOCATIONService,
...
export class IDD_SALE_ORDER_ALLOCATIONFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_SALE_ORDER_ALLOCATIONComponent, resolver);
    }
} 