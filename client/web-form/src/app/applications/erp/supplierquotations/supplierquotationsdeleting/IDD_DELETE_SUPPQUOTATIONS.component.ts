...
import { IDD_DELETE_SUPPQUOTATIONSService } from './IDD_DELETE_SUPPQUOTATIONS.service';

@Component({
    selector: 'tb-IDD_DELETE_SUPPQUOTATIONS',
    templateUrl: './IDD_DELETE_SUPPQUOTATIONS.component.html',
...
export class IDD_DELETE_SUPPQUOTATIONSFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_DELETE_SUPPQUOTATIONSComponent, resolver);
    }
} 