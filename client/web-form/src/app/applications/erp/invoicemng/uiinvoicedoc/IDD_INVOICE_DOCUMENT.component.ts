...
import { IDD_INVOICE_DOCUMENTService } from './IDD_INVOICE_DOCUMENT.service';

@Component({
    selector: 'tb-IDD_INVOICE_DOCUMENT',
    templateUrl: './IDD_INVOICE_DOCUMENT.component.html',
    providers: [IDD_INVOICE_DOCUMENTService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_INVOICE_DOCUMENTComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_INVOICE_DOCUMENTService,
...
export class IDD_INVOICE_DOCUMENTFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_INVOICE_DOCUMENTComponent, resolver);
    }
} 