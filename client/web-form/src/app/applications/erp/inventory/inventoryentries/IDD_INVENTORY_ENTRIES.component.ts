...
import { IDD_INVENTORY_ENTRIESService } from './IDD_INVENTORY_ENTRIES.service';

@Component({
    selector: 'tb-IDD_INVENTORY_ENTRIES',
    templateUrl: './IDD_INVENTORY_ENTRIES.component.html',
...
public IDC_HEADER_ENTRY_CODETYPE_SPECIFICATOR_RTGSTEP2_itemSource: any;
    ...
    constructor(document: IDD_INVENTORY_ENTRIESService,
...
export class IDD_INVENTORY_ENTRIESFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_INVENTORY_ENTRIESComponent, resolver);
    }
} 