...
import { IDD_USER_DEF_INVENTORY_FULLService } from './IDD_USER_DEF_INVENTORY_FULL.service';

@Component({
    selector: 'tb-IDD_USER_DEF_INVENTORY_FULL',
    templateUrl: './IDD_USER_DEF_INVENTORY_FULL.component.html',
...
export class IDD_USER_DEF_INVENTORY_FULLFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_USER_DEF_INVENTORY_FULLComponent, resolver);
    }
} 