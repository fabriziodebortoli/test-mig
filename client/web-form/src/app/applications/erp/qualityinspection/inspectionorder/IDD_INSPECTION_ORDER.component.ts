...
import { IDD_INSPECTION_ORDERService } from './IDD_INSPECTION_ORDER.service';

@Component({
    selector: 'tb-IDD_INSPECTION_ORDER',
    templateUrl: './IDD_INSPECTION_ORDER.component.html',
    providers: [IDD_INSPECTION_ORDERService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_INSPECTION_ORDERComponent extends BOComponent implements OnInit, OnDestroy {
     public IDC_INSPORDER_TYPE_SPECIFICATOR_1_itemSource: any;
public IDC_INSPORDER_TYPE_SPECIFICATOR_2_itemSource: any;

    constructor(document: IDD_INSPECTION_ORDERService,
...
export class IDD_INSPECTION_ORDERFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_INSPECTION_ORDERComponent, resolver);
    }
} 