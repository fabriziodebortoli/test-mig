...
import { IDD_LOAD_RFCService } from './IDD_LOAD_RFC.service';

@Component({
    selector: 'tb-IDD_LOAD_RFC',
    templateUrl: './IDD_LOAD_RFC.component.html',
    providers: [IDD_LOAD_RFCService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
    export class IDD_LOAD_RFCComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_LOAD_RFCService,
...
export class IDD_LOAD_RFCFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_LOAD_RFCComponent, resolver);
    }
} 