...
import { IDD_LOAD_BOLService } from './IDD_LOAD_BOL.service';

@Component({
    selector: 'tb-IDD_LOAD_BOL',
    templateUrl: './IDD_LOAD_BOL.component.html',
    providers: [IDD_LOAD_BOLService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_LOAD_BOLComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_LOAD_BOLService,
...
export class IDD_LOAD_BOLFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_LOAD_BOLComponent, resolver);
    }
} 