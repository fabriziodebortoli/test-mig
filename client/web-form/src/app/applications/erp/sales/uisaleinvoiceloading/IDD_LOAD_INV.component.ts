...
import { IDD_LOAD_INVService } from './IDD_LOAD_INV.service';

@Component({
    selector: 'tb-IDD_LOAD_INV',
    templateUrl: './IDD_LOAD_INV.component.html',
    providers: [IDD_LOAD_INVService, ComponentInfoService],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class IDD_LOAD_INVComponent extends BOComponent implements OnInit, OnDestroy {
     
    constructor(document: IDD_LOAD_INVService,
...
export class IDD_LOAD_INVFactoryComponent {
    constructor(componentService: ComponentService, resolver: ComponentFactoryResolver) {
        componentService.createComponent(IDD_LOAD_INVComponent, resolver);
    }
} 