    ...
    return gulp.src(`${buildFolder}/**/*.js`)
        ...
        .pipe(rollup({
            ...
            external: [
                ...
                '@taskbuilder/icons', '@taskbuilder/libs',
                'rxjs/add/operator/concat', 'rxjs/add/operator/publishLast', 'rxjs/observable/of', 'rxjs/operator/concat', 'rxjs/operator/publishLast', 'rxjs/operator/toPromise',
                'rxjs/observable/ConnectableObservable', 'rxjs/ReplaySubject', 'rxjs/operators', 'rxjs/add/observable/merge',
                'rxjs/add/observable/merge', 'rxjs/operators', 'rxjs/operators/delay', 'rxjs',
                '@angular/common/http', '@angular/common/http',
                '@angular/common/locales/bg', '@angular/common/locales/de-CH', '@angular/common/locales/el', '@angular/common/locales/en', '@angular/common/locales/es-CL',
                '@angular/common/locales/hu', '@angular/common/locales/it', '@angular/common/locales/it-CH', '@angular/common/locales/pl', '@angular/common/locales/ro',
