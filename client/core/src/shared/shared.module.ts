...
const TB_COMPONENTS = [
    ...
    UnsupportedComponent, UnsupportedFactoryComponent, OpenComponent, SaveComponent, RadarComponent, CultureSelectorComponent, EasyStudioContextComponent, TbIconComponent
];
