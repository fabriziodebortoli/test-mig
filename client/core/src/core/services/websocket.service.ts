...
export class WebSocketService extends LocalizationService {
            ...
            if (typeof (e.data) === 'string') {
                ...
                try {
                    switch (obj.cmd) {
                        ...
                        case 'ExistDataCompleted': $this.existDataCompleted.emit({
                            found: obj.args['found'], value: obj.args['value'],
                            mustExist: obj.args['mustExist'], requestId: obj.args['requestId']
                        }); break;
    ...
    doFillListBox(cmpId: String, obj: any): void {
        const data = { cmd: 'doFillListBox', cmpId: cmpId, itemSourceName: obj.itemSourceName, itemSourceNamespace: obj.itemSourceNamespace, hotLink: obj.hotLink, controlId: obj.cmpId };

        this.safeSend(data);
    }

    doCheckListBoxAction(cmpId: String, obj: any): void {
        const data = { cmd: 'doCheckListBoxAction', cmpId: cmpId, itemSourceName: obj.itemSourceName, itemSourceNamespace: obj.itemSourceNamespace, controlId: obj.cmpId, action: obj.action, list: obj.list, itemID: obj.itemID };
